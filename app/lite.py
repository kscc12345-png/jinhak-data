...
MATCH_LABEL = {
    ...
    "요강근거": "요강의 그 전형 절·표에서 범위째 읽은 기준",
    "요강명시": "요강이 '이 전형은 최저 없음' 이라고 적은 것",
    "이름일치": "이 학과에 명시된 기준",
    "이름일치(타전형)": "다른 전형에서 같은 학과 이름을 찾은 기준 — 참고용",
...
#  '어디가' 는 어디가 결과표에만 있는 학과다. 요강에서 못 찾았으니
#  최저는 '없음' 이 아니라 '모른다' 다 — 고려대(서울) 의예과가 최저
#  4개 합 5 인데 이 줄에는 아무것도 없었다(실측).
MATCH_CAUTION = {"단과일치", "단과일치(타전형)", "이름일치(타전형)",
                 "계열추정", "전형공통", "미확인", "어디가"}
